...
$sql = "INSERT INTO Customers (menu_id,telephone_no,firstName,lastName,apt_no,street,city,cost,employee_ssn) VALUES($name1,$name2,'$name3','$name4',$name5,'$name6','$name7',$name8,$name9)";
